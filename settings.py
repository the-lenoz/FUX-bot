...
mechanic_checkup = (
    'Здесь ты можешь отслеживать своё состояние — эмоциональное и продуктивное — в динамике.'
    ...
    '📈В конце каждой недели ты получишь наглядный график — как менялось твое состояние по дням. Это поможет увидеть закономерности и вовремя отреагировать на спады.'
    '🗓️В конце месяца я пришлю тебе календарь с полной статистикой — весь месяц как на ладони: какой был ритм, где ты чувствовал(а) себя лучше всего.'
    '🏆А ещё — я выберу лучшую неделю месяца по состоянию и выделю её отдельно по окончанию месяца. Так будет проще замечать, когда ты был(а) на пике — и что этому способствовало.'
    '🧡Попробуем? Тогда выбери, за каким состоянием будем следить на этой неделе.',
