...
mechanic_checkup = (
    ...
    '🏆А ещё — я выберу <b>лучшую</b> неделю месяца по состоянию и выделю её отдельно по <i>окончанию месяца</i>. Так будет проще замечать, когда ты был(а) на пике — и что этому способствовало.\n\n'
