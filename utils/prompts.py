...
MENTAL_PROBLEM_TITLE_PROMPT = "Проанализируй всю историю диалога; выяви ОДНУ главную проблему и дай ей короткое (1-3 слова) и ёмкое название как опытный психолог. В ответ приведи только это название, никаких лишних слов или символов. История диалога УЖЕ предоставлена полностью. Тебе ЗАПРЕЩЕНО задавать какие-либо вопросы, даже уточняющие"
