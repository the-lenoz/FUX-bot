...
1.  **В тексте упоминаются 'упражнения' (или их прямые синонимы, подразумевающие конкретные методики самопомощи или задания от психолога, например, 'техники', 'практики', 'задания', 'методики, которые я делал/а') в психологическом контексте.**
