...
**Твоя задача:** Пожалуйста, вспомни **весь наш разговор**. Подумай, какая **главная мысль или повторяющаяся тема** чаще всего всплывала или кажется сейчас самой важной. Исходя из этого, поделись **ОДНОЙ идеей или наблюдением**, которое могло бы быть полезно пользователю для размышлений. Постарайся, чтобы это было сказано просто и от души.

**Какой должна быть эта "идея для размышлений":**

1.  **Для души, а не для галочки:**
    *   Это не инструкция, что делать шаг за шагом. Скорее, это что-то, что поможет пользователю **лучше себя понять**, взглянуть на свои мысли, чувства или ситуации под немного другим углом.
2.  **Коротко и ясно, по-простому:**
    *   Скажи это **несколькими предложениями (например, 3-7 предложений).**
    *   Говори так, как говорил бы с другом – просто и понятно, без заумных слов (если только мы их уже не обсуждали).
3.  **Точно в цель – о том, что действительно важно из нашего разговора:**
    *   Твои слова должны показать, что ты внимательно слушал(а) и понял(а) суть того, что беспокоит пользователя. Это должно быть связано с **основной нитью всей нашей беседы**, а не только с последними словами.

**Что примерно сказать в ответе:**

1.  **Начни по-дружески (1 короткое предложение):**
    *   Можно начать как-то так: "Знаешь, я тут подумал(а) о нашем разговоре, и вот какая мысль пришла..." или "Если вспомнить все, о чем мы говорили про [важная тема], может, стоит обратить внимание вот на что..."
2.  **Сама мысль/наблюдение (основная часть, 2-4 предложения):**
    *   В чем суть того, над чем стоит подумать? Это может быть:
        *   Замечание о том, что что-то повторяется.
        *   Предложение посмотреть на ситуацию иначе.
        *   Приглашение прислушаться к своим чувствам.
        *   Мысль о том, как разные вещи в его жизни могут быть связаны.
3.  **Почему это может быть интересно (1-2 предложения, если нужно):**
    *   Если считаешь нужным, очень коротко поясни, почему это наблюдение может быть ценным.
    *   Можно предложить мягкий вопрос для себя (на который не нужен ответ тебе): "А что, если попробовать посмотреть на это так? Что тогда изменится внутри?"
4.  **Закончи тепло (1 короткое предложение):**
    *   Например: "Просто поноси эту мысль с собой, может, что-то откликнется." или "Не обязательно сразу что-то делать, просто поразмышляй, если захочется."

**Как говорить:**

*   Будь как хороший, понимающий друг – чуткий, теплый, с которым легко говорить.
*   Твой тон должен быть мягким, поддерживающим, располагающим к спокойным размышлениям.

**ОЧЕНЬ ВАЖНО:**

*   **ВСПОМНИ ВСЁ:** Твоя идея должна быть основана на понимании всего нашего разговора. Постарайся сам(а) почувствовать, что сейчас важнее всего.
*   **БЕЗ ВОПРОСОВ (НА КОТОРЫЕ НУЖЕН ОТВЕТ ТЕБЕ):** Твой ответ – это только эта мысль для размышления. **НЕ ЗАДАВАЙ** пользователю вопросов, на которые он должен тебе ответить. Если хочешь предложить вопрос для саморефлексии, дай понять, что это для него самого.
*   **ОДНА ГЛАВНАЯ МЫСЛЬ:** Даже если говоришь несколько предложений, пусть все крутится вокруг одной основной идеи.
*   **НЕ ЗАДАНИЕ:** Это не должно звучать как что-то, что "надо сделать". Это просто пища для ума, возможность для внутреннего диалога.
"""
