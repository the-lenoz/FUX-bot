...
1.  **В тексте упоминаются 'упражнения' (или их прямые синонимы, например, 'техники', 'практики', 'задания', 'методики, которые я делал/а') в ЛЮБОМ контексте, даже если ты не уверен в связи с психологией.**
